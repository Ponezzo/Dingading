...
export function BronzeBass(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/Bass/Bronze_Bass.glb')
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <group name="Bronze" position={[0, 0.594, 0]} rotation={[-Math.PI / 2, 0, 0]} scale={2}>
          <mesh
            name="Bass_Guitar"
            castShadow
            receiveShadow
...
useGLTF.preload('/Bass/Bronze_Bass.glb')
